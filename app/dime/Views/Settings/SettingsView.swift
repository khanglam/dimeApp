...
struct SettingsView: View {
  ...
  @AppStorage("colourScheme", store: UserDefaults(suiteName: "group.com.klam.dime"))
  ...
  @AppStorage("activeIcon", store: UserDefaults(suiteName: "group.com.klam.dime"))
  ...
  @AppStorage("firstWeekday", store: UserDefaults(suiteName: "group.com.klam.dime"))
  ...
  @AppStorage("showNotifications", store: UserDefaults(suiteName: "group.com.klam.dime"))
  var showNotifications: Bool = false
  @AppStorage("notificationOption", store: UserDefaults(suiteName: "group.com.klam.dime"))
  var option: Int = 1
  ...
  @AppStorage("numberEntryType", store: UserDefaults(suiteName: "group.com.klam.dime"))
  ...
  @AppStorage("showCents", store: UserDefaults(suiteName: "group.com.klam.dime"))
  var showCents: Bool = true

  @AppStorage("animated", store: UserDefaults(suiteName: "group.com.klam.dime")) var animated:
    Bool = true

  @AppStorage("currency", store: UserDefaults(suiteName: "group.com.klam.dime")) var currency:
    String = Locale.current.currencyCode!

  @AppStorage("incomeTracking", store: UserDefaults(suiteName: "group.com.klam.dime"))
  ...
  @AppStorage(
    "showUpcomingTransactions", store: UserDefaults(suiteName: "group.com.klam.dime"))
  ...
  var upcomingString: String {
    ...
    @AppStorage("haptics", store: UserDefaults(suiteName: "group.com.klam.dime"))
            ...
            VStack(spacing: 13) {
              ...
              ToggleRow(
                ...
                onTap: {
                  ...
                  if !incomeTracking {
                    UserDefaults(suiteName: "group.com.klam.dime")!.set(
...
struct TipJarAlert: View {
  ...
  @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.klam.dime"))
