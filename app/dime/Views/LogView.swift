...
struct LogView: View {
    ...
    @AppStorage("showCents", store: UserDefaults(suiteName: "group.com.klam.dime")) var showCents: Bool = true

    var topEdge: CGFloat

    @AppStorage("currency", store: UserDefaults(suiteName: "group.com.klam.dime")) var currency: String = Locale.current.currencyCode!
    ...
    @AppStorage("logTimeFrame", store: UserDefaults(suiteName: "group.com.klam.dime")) var logTimeFrame = 2
...
struct LogInsightsView: View {
    ...
    @AppStorage("logInsightsTimeFrame", store: UserDefaults(suiteName: "group.com.klam.dime")) var timeframe = 2
    @AppStorage("logInsightsType", store: UserDefaults(suiteName: "group.com.klam.dime")) var insightsType = 1

    @AppStorage("logViewLineGraph", store: UserDefaults(suiteName: "group.com.klam.dime")) var lineGraph: Bool = false
    ...
    var range: Int {
        ...
        calendar.firstWeekday = UserDefaults(suiteName: "group.com.klam.dime")?.integer(forKey: "firstWeekday") ?? 0
...
struct TimePickerView: View {
    ...
    @AppStorage("colourScheme", store: UserDefaults(suiteName: "group.com.klam.dime")) var colourScheme: Int = 0
...
struct TransactionsList: View {
    ...
    @AppStorage("showUpcomingTransactions", store: UserDefaults(suiteName: "group.com.klam.dime")) var showUpcoming: Bool = true
    @AppStorage("showUpcomingTransactionsWhenUpcoming", store: UserDefaults(suiteName: "group.com.klam.dime")) var showSoon: Bool = false
...
struct ListView: View {
    ...
    @AppStorage("showExpenseOrIncomeSign", store: UserDefaults(suiteName: "group.com.klam.dime"))
    var showExpenseOrIncomeSign: Bool = true

    @AppStorage("swapTimeLabel", store: UserDefaults(suiteName: "group.com.klam.dime")) var swapTimeLabel: Bool = false
...
struct DeleteTransactionAlert: View {
    ...
    @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.klam.dime")) var bottomEdge: Double = 15
